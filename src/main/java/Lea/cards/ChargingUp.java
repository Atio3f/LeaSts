...
public class ChargingUp extends CrosscodeCard {
    public static final String ID = "leacrosscode:ChargingUp";
    ...
    private static final int SHOCK_DMG = 7;
    private static final int UPGRADE_PLUS_DMG = 2;
    private static final int JOLT_AMT = 3;
    private static final int UPGRADE_JOLT_AMT = 1;
    ...
    public ChargingUp() {
        ...
        logger.info("Charging up" + DESCRIPTION + "---------------------------------------------------------------------------------------------------------------------------------\n\n");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        //Pouvoir qui prend en param le magicNumber pour le jolt power et SHOCK_DMG pour les dégats de SHOCK
        super.use(p, m);
    }

    @Override
    public AbstractCard makeCopy() {
        logger.info("ChargingUpCOPY---------------------------------------------------------------------------------------------------------------------------------\n\n");
    ...
    public void upgrade() {
        if (!this.upgraded) {
            this.upgradeName();
            this.upgradeMagicNumber(UPGRADE_JOLT_AMT);
        }
    }
}
