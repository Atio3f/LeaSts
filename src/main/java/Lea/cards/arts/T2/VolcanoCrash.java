...
//Fire Dash T2 -> Deal damage and apply burn to ALL ennemi. Gain Block
// A CHANGER J'AI LAISSE AMBERBREAKER pour l'instaznt
public class VolcanoCrash extends CrosscodeCard {
    public static final String ID = "leacrosscode:VolcanoCrash";
    ...
    private static final int JOLT_APPLY = 10;
    private static final int HEAT_COST = 4; //p-ê plus jsp
    ...
    public AbstractCard makeCopy() {
        logger.info("VolcanoCrashCOPY---------------------------------------------------------------------------------------------------------------------------------\n\n");
        return new VolcanoCrash();
    }
